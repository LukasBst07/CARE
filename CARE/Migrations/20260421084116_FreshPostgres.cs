...
{
    /// <inheritdoc />
    public partial class FreshPostgres : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Eco2 = table.Column<double>(type: "double precision", nullable: false),
                    Db = table.Column<double>(type: "double precision", nullable: false),
                    TotalScore = table.Column<int>(type: "integer", nullable: false),
                    ScoreLux = table.Column<int>(type: "integer", nullable: false),
                    ScoreTemp = table.Column<int>(type: "integer", nullable: false),
                    ScoreHumidity = table.Column<int>(type: "integer", nullable: false),
                    ScoreEco2 = table.Column<int>(type: "integer", nullable: false),
                    ScoreDb = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Telemetry_Classrooms_ClassroomId",
